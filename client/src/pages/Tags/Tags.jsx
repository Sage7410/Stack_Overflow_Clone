...
const Tags = () => {
    ...
    const tagsList = [{
        ...
        id: 7,
        tagName: "android",
        tagDesc: "Android is Google's mobile operating system, used for programming or developing digital devices (Smartphones, Tablets, Automobiles, TVs, Wear, Glass, loT)."
    },{
        id: 8,
        tagName: "css",
  ...
  return (
    <div className='home-container-1'>
        ...
        <div className='home-container-2'>
            <h1 className='tags-h1'>Tags page</h1>
