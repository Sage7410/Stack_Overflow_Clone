            ...
            <form onSubmit={handleSubmit}>
                <div className='ask-from-container'>
                    <label htmlFor='ask-ques-title'>
                        ...
                        <input type='text' id='ask-ques-title' onChange={(e) => {setQuestionTitle(e.target.value)}} placeholder='eg. Is there an R function for finding the index of an element in vecror?'/>
                    </label>
